	...
	<div class="container-fluid" style="margin-top: 100px;">
	    ...
	    <div class="row">
			                ...
			                %>
			                	<tr>
			                        ...
			                        <td>
			                        	...
			                        	<form action="/ClinicManagement/MedicalFile?id=<%=id_patient %>" method="POST">
	        ...
	        <div class="card shadow mb-4" style="width: 100%;">
	            ...
	            <div class="my-2"></div>
	                <a href="/ClinicManagement/AddConsultation?id=<%=id_patient %>" class="btn btn-success btn-icon-split" style="margin-left: 15px;width: 23%;">
