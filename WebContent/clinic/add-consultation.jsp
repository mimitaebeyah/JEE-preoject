        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-10">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
	                    <form action="/ClinicManagement/AddConsultation?id=<%=id_patient %>" method="POST" style="color: black;">
							...
							<a href="/ClinicManagement/MedicalFile?id=<%=id_patient %>" class="btn btn-danger ">Quitter</a>
