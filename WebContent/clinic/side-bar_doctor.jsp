...
%>
    ...
    <head>
    	<link rel="stylesheet" href="/ClinicManagement/clinic/css/notif.css">
	...
	<header class="header" id="header">
		        ...
		        <div class="notification_dd">
		            ...
		            <ul class="notification_ul">
		                ...
		                <li>
						    ...
						    { %>
		                    	<img src="/ClinicManagement/clinic/images/woman.png"> <% }
		                	else
						    { %>
								<img src="/ClinicManagement/clinic/images/man.png"> <% }
							%>
		                ...
		                <li class="show_all">
		                    <a href="/ClinicManagement/clinic/RendezVous?type=N" class="link">Afficher toutes les Rendez-Vous</a>
		                </li> 
		            </ul>
		        </div>
	    ...
	    <div class="header__img">
	        <img src="/ClinicManagement/clinic/images/perfil.jpg" alt="">
	    </div>
	...
	<div class="l-navbar" id="nav-bar">
	    <nav class="nav">
	        <div>
	            ...
	            <div class="nav__list">
	                <a href="/ClinicManagement/S_Home" class="nav__link active">
	                <i class='bx bx-grid-alt nav__icon' ></i>
	                    <span class="nav__name">Dashboard</span>
	                </a>
	
	                <a href="/ClinicManagement/S_Patients" class="nav__link">
	                    <i class='bx bx-user nav__icon' ></i>
	                    <span class="nav__name">Patients</span>
	                </a>
	                
	                <a href="/ClinicManagement/S_RendezVous?type=A" class="nav__link">
	                    <i class='bx bx-message-square-detail nav__icon' ></i>
	                    <span class="nav__name">Rendez-vous</span>
	                </a>
	
	                <a href="/ClinicManagement/S_RendezVous?type=H" class="nav__link">
